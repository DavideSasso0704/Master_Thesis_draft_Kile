...
\end{table}
The absence of a column dedicated to the eccentricty sampling in Table \ref{tab:H best-fit parameters} reflects one of the main findings from \textcite{Quinlan_1996} and \textcite{Sesana_2006} scattering experiments, that is the dimensionless hardening rate $H_u$ is almost indipendent of the BH binary eccentricity. This result, shown in Figure \ref{fig:H_comparison}, is in perfect agreement with the main statement of Heggie's law discussed in \S~\ref{sec:Gravitational Slingshot Effect}.
...
We anticipate that Equations  will be integrated with the help of RK(4) and $dK/de$ is needed as well; Figure depicts the step-like function.
