...
\begin{figure}[H]
    ...
    \label{IMBH_Pathways}
\end{figure}
Within the framework of the hierarchical growth scenario of galaxies \parencite{White_1978}, the formation of IMBH binaries is expected to occur naturally as a consequence of mergers between their host stellar systems \parencite{Maiolino_2024}. These systems are among the most powerful sources of gravitational waves (GWs) in the Universe \parencite{Maggiore_book}, making them prime targets for current and future GW observatories. In particular, the upcoming Laser Interferometer Space Antenna (LISA), a joint ESA/NASA space mission, will probe the low-frequency GW regime, from $\sim 10^{-4}$ to $\sim 10^{-1}$ Hz \parencite{Amaro-Seoane_2017,Amaro-Seaone_2023}, providing access to compact-object binaries with masses of $\sim10^4-10^7,M_\odot$ and enabling the detection of their mergers out to redshift $z\sim20$ \parencite{Colpi_2024}. At higher frequencies, the ground-based Einstein Telescope (ET) will complement LISA by extending the accessible frequency and mass ranges towards lower-mass systems, being expected to detect IMBH binaries with masses of $\sim10^2-10^3,M_\odot$ out to redshifts of a few \parencite{ET_book}.\\This thesis work aims to investigate the evolution of the main orbital parameters of IMBH binaries, focusing on the semimajor axis $a$ and eccentricity $e$, and to assess how the BH masses, properties of the stellar background, and initial binary conditions, i.e. $(a_0,e_0)$, affect their dynamical evolution and coalescence time through a series of numerical experiments. To this end, different stellar environments hosting the binary—or the individual unbound IMBHs—are considered, with dwarf galaxies representing the first candidate systems.\\Although the merger rate of such low-mass galaxies is not yet well constrained, the growing evidence of the existence at high redshifts of such candidates \parencite{Kikuchihara_2020} rises the possibility of detecting GWs from merging IMBH binaries if coalescence occurs within the Hubble time.\\According to the findings of \parencite{Khan_2024}, the low central stellar density of non-nucleated dwarfs leads to inefficient hardening and, ultimately, to binary stalling. However, the vast majority of galaxies with stellar masses of $10^8-10^{11},M_\odot$ host a nuclear star cluster (NSC), an exceptionally dense and dynamically distinct stellar component in their innermost regions (see, e.g., \textcite{Neumayer_2020}). The presence of such a dense environment within dwarf galaxies, as reported, e.g., by \textcite{Nguyen_2018}, has been confirmed to substantially shorten the coalescence time of an IMBH pair.\\Having established the key role of stellar scattering, and hence of the stellar density at the binary influence radius, the time evolution of the IMBH binary separation and eccentricity, $a(t)$ and $e(t)$, is then obtained by numerically integrating their evolution while artificially placing present-day non-nucleated dwarf galaxies at higher redshifts, following the cosmic size evolution low inferred by \textcite{Ono_2023}.\\Furthermore,





Then stellar clumps because:

1)Observation and numerical experiments The emergence of x-ray signatures from Globular Clusters (GCs), combined with the \textcite{Gebhardt_2005}

2)Observation of high z stellar clumps \textcite{Eros_2026}

plot di Eros

e plot di \textcite{Maiolino_2024} per Mbh vs Mstar



the study combines a self-consistent hybrid model developed by \textcite{Quinlan_1996} and extended by \textcite{Sesana_2010} with N-body simulations performed using the KETJU module \parencite{Mannerkoski_2023}, implemented into GADGET-4. which will be described in more detail later. These powerfull tools, that will be properly discussed in chapter \ref{chap:chapter2} and chapter \ref{chap:chapter3}, enable to
\\N-body numerical experiments have proved different stellar backgrounds give rise to different pathways to the possible coalescence of MBHBs (see, e.g. \textcite{Khan_2021}; \textcite{Khan_2024}). Therefore, in this work, evolutionary tracks of BH binaries are reconstructed by considering different host models, motivated by observational evidences or strong indications from numerical simulations.
...
Among them, in this work have been considered: dwarf galaxies





between galaxies. . .\\Despite,




The structure of this thesis is outlined as follows.\\In \autoref{chap:chapter1}, we provide a brief overview of the main physical mechanisms responsible for the BH binary shrinking; this includes violent relaxation, dynamical friction, stellar scattering from low-angular momentum stars and GWs emission.\\In \autoref{chap:chapter2}, we introduce the self-consistent hybrid model developed by \textcite{Quinlan_1996} and \textcite{Sesana_2010}, hence showing the obtained evolutionary tracks related to a sample of adopted host galaxies and discussing  the parameters space in order to emphasise how different environmental and initial conditions lead to different binary evolution.\\In \autoref{chap:chapter3} we describe the main features of the codes used to generate N-body initial condition and N-body numerical simulations and compare the obtained binary evolutionary tracks with those of the previous chapter.\\Finally, the main results of this work are summarized, and possible future improvements are reported in the concluding chapter.
%\clearpage
