...
At this stage, the binary separation is sufficiently small that distant stars mainly perturb the motion of the binary's center of mass, with negligible effect on its orbital energy \parencite{Quinlan_1996}. Further hardening is therefore driven predominantly by low angular momentum stars passing in the vicinity of the binary and extracting both energy and angular momentum from it. Each time such a star, hereafter referred to as a "loss-cone star, passes sufficiently close to the binary, a three-body encounter takes place. Under suitable conditions,
this interaction produces hyper-velocity stars \parencite{Sesana_2006} through the so-called stellar slingshot mechanism \parencite{Mikkola_1992}. In this section, we review the main physical aspects of three-body encounters.\\Let us focus on the so-called "two-body problem" and some the related results as they will be usefull in dealing with the physics of the stellar slingshot. Given the test and field particles, of masses $m_t$ and $m_f$ respectively and reduced mass $\mu$, the system total energy in the mass center frame $S_{CM}$ turns out to be
\begin{equation}
\label{E_in_S_cm}
